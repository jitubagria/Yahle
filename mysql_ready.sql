...
CREATE TABLE IF NOT EXISTS ai_tool_requests (
    id integer NOT NULL,
...
ALTER TABLE ai_tool_requests OWNER TO neondb_owner;
...
ALTER SEQUENCE ai_tool_requests_id_seq OWNER TO neondb_owner;

--
-- Name: ai_tool_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE ai_tool_requests_id_seq OWNED BY ai_tool_requests.id;
...
CREATE TABLE IF NOT EXISTS bigtos_messages (
    id integer NOT NULL,
...
ALTER TABLE bigtos_messages OWNER TO neondb_owner;
...
ALTER SEQUENCE bigtos_messages_id_seq OWNER TO neondb_owner;

--
-- Name: bigtos_messages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE bigtos_messages_id_seq OWNED BY bigtos_messages.id;
...
CREATE TABLE IF NOT EXISTS certificates (
    ...
    output_url text,
    sent_status TINYINT(1) DEFAULT false,
    sent_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE certificates OWNER TO neondb_owner;
...
ALTER SEQUENCE certificates_id_seq OWNER TO neondb_owner;
...
CREATE TABLE IF NOT EXISTS course_certificates (
    ...
    sent_whatsapp TINYINT(1) DEFAULT false,
    certificate_number character varying(100) NOT NULL
);


ALTER TABLE course_certificates OWNER TO neondb_owner;
...
ALTER SEQUENCE course_certificates_id_seq OWNER TO neondb_owner;

--
-- Name: course_certificates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE course_certificates_id_seq OWNED BY course_certificates.id;
...
CREATE TABLE IF NOT EXISTS course_modules (
    ...
    duration integer,
    is_preview TINYINT(1) DEFAULT false,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE course_modules OWNER TO neondb_owner;
...
ALTER SEQUENCE course_modules_id_seq OWNER TO neondb_owner;

--
-- Name: course_modules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE course_modules_id_seq OWNED BY course_modules.id;
...
ALTER TABLE course_progress OWNER TO neondb_owner;
...
ALTER SEQUENCE course_progress_id_seq OWNER TO neondb_owner;

--
-- Name: course_progress_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE course_progress_id_seq OWNED BY course_progress.id;
...
ALTER TABLE courses OWNER TO neondb_owner;
...
ALTER SEQUENCE courses_id_seq OWNER TO neondb_owner;
...
CREATE TABLE IF NOT EXISTS doctor_profiles (
    ...
    dob date,
    gender gender,
    marriatialstatus marital_status,
    ...
    isprofilecomplete TINYINT(1) DEFAULT false,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
ALTER TABLE doctor_profiles OWNER TO neondb_owner;
...
ALTER SEQUENCE doctor_profiles_id_seq OWNER TO neondb_owner;

--
-- Name: doctor_profiles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE doctor_profiles_id_seq OWNED BY doctor_profiles.id;
...
CREATE TABLE IF NOT EXISTS enrollments (
    ...
    completed_at timestamp without time zone,
    certificate_issued TINYINT(1) DEFAULT false,
    enrolled_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    payment_status payment_status DEFAULT 'free'::payment_status,
    payment_id character varying(100)
);


ALTER TABLE enrollments OWNER TO neondb_owner;
...
ALTER SEQUENCE enrollments_id_seq OWNER TO neondb_owner;
...
ALTER TABLE entity_templates OWNER TO neondb_owner;
...
ALTER SEQUENCE entity_templates_id_seq OWNER TO neondb_owner;

--
-- Name: entity_templates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE entity_templates_id_seq OWNED BY entity_templates.id;
...
ALTER TABLE hospitals OWNER TO neondb_owner;
...
ALTER SEQUENCE hospitals_id_seq OWNER TO neondb_owner;
...
ALTER TABLE job_applications OWNER TO neondb_owner;
...
ALTER SEQUENCE job_applications_id_seq OWNER TO neondb_owner;
...
ALTER TABLE jobs OWNER TO neondb_owner;
...
ALTER SEQUENCE jobs_id_seq OWNER TO neondb_owner;
...
ALTER TABLE masterclass_bookings OWNER TO neondb_owner;
...
ALTER SEQUENCE masterclass_bookings_id_seq OWNER TO neondb_owner;

--
-- Name: masterclass_bookings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE masterclass_bookings_id_seq OWNED BY masterclass_bookings.id;
...
ALTER TABLE masterclasses OWNER TO neondb_owner;
...
ALTER SEQUENCE masterclasses_id_seq OWNER TO neondb_owner;

--
-- Name: masterclasses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE masterclasses_id_seq OWNED BY masterclasses.id;
...
CREATE TABLE IF NOT EXISTS medical_voice_contacts (
    id integer NOT NULL,
...
ALTER TABLE medical_voice_contacts OWNER TO neondb_owner;
...
ALTER SEQUENCE medical_voice_contacts_id_seq OWNER TO neondb_owner;

--
-- Name: medical_voice_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE medical_voice_contacts_id_seq OWNED BY medical_voice_contacts.id;
...
CREATE TABLE IF NOT EXISTS medical_voice_gathering_joins (
    id integer NOT NULL,
    voice_id integer NOT NULL,
    user_id integer NOT NULL,
    status rsvp_status DEFAULT 'interested'::rsvp_status,
    remarks text,
    joined_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE medical_voice_gathering_joins OWNER TO neondb_owner;
...
ALTER SEQUENCE medical_voice_gathering_joins_id_seq OWNER TO neondb_owner;

--
-- Name: medical_voice_gathering_joins_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE medical_voice_gathering_joins_id_seq OWNED BY medical_voice_gathering_joins.id;
...
CREATE TABLE IF NOT EXISTS medical_voice_supporters (
    id integer NOT NULL,
    voice_id integer NOT NULL,
    user_id integer NOT NULL,
...
ALTER TABLE medical_voice_supporters OWNER TO neondb_owner;
...
ALTER SEQUENCE medical_voice_supporters_id_seq OWNER TO neondb_owner;

--
-- Name: medical_voice_supporters_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE medical_voice_supporters_id_seq OWNED BY medical_voice_supporters.id;
...
CREATE TABLE IF NOT EXISTS medical_voice_updates (
    id integer NOT NULL,
    voice_id integer NOT NULL,
    update_title character varying(255),
    update_body text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    notify_supporters TINYINT(1) DEFAULT true
);


ALTER TABLE medical_voice_updates OWNER TO neondb_owner;
...
ALTER SEQUENCE medical_voice_updates_id_seq OWNER TO neondb_owner;

--
-- Name: medical_voice_updates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE medical_voice_updates_id_seq OWNED BY medical_voice_updates.id;
...
CREATE TABLE IF NOT EXISTS medical_voices (
    id integer NOT NULL,
    title character varying(255) NOT NULL,
    ...
    status voice_status DEFAULT 'active'::voice_status,
    supporters_count integer DEFAULT 0,
    has_gathering TINYINT(1) DEFAULT false,
...
ALTER TABLE medical_voices OWNER TO neondb_owner;
...
ALTER SEQUENCE medical_voices_id_seq OWNER TO neondb_owner;

--
-- Name: medical_voices_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE medical_voices_id_seq OWNED BY medical_voices.id;
...
ALTER TABLE module_tests OWNER TO neondb_owner;
...
ALTER SEQUENCE module_tests_id_seq OWNER TO neondb_owner;

--
-- Name: module_tests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE module_tests_id_seq OWNED BY module_tests.id;
...
CREATE TABLE IF NOT EXISTS npa_automation (
    id integer NOT NULL,
    ...
    status npa_automation_status DEFAULT 'pending'::npa_automation_status,
...
ALTER TABLE npa_automation OWNER TO neondb_owner;
...
ALTER SEQUENCE npa_automation_id_seq OWNER TO neondb_owner;

--
-- Name: npa_automation_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE npa_automation_id_seq OWNED BY npa_automation.id;
...
CREATE TABLE IF NOT EXISTS npa_opt_ins (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
ALTER TABLE npa_opt_ins OWNER TO neondb_owner;
...
ALTER SEQUENCE npa_opt_ins_id_seq OWNER TO neondb_owner;

--
-- Name: npa_opt_ins_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE npa_opt_ins_id_seq OWNED BY npa_opt_ins.id;
...
CREATE TABLE IF NOT EXISTS npa_templates (
    id integer NOT NULL,
    title character varying(255) NOT NULL,
    description text,
...
ALTER TABLE npa_templates OWNER TO neondb_owner;
...
ALTER SEQUENCE npa_templates_id_seq OWNER TO neondb_owner;

--
-- Name: npa_templates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE npa_templates_id_seq OWNED BY npa_templates.id;
...
ALTER TABLE quiz_attempts OWNER TO neondb_owner;
...
ALTER SEQUENCE quiz_attempts_id_seq OWNER TO neondb_owner;

--
-- Name: quiz_attempts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE quiz_attempts_id_seq OWNED BY quiz_attempts.id;
...
ALTER TABLE quiz_leaderboard OWNER TO neondb_owner;
...
ALTER SEQUENCE quiz_leaderboard_id_seq OWNER TO neondb_owner;

--
-- Name: quiz_leaderboard_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE quiz_leaderboard_id_seq OWNED BY quiz_leaderboard.id;
...
ALTER TABLE quiz_questions OWNER TO neondb_owner;
...
ALTER SEQUENCE quiz_questions_id_seq OWNER TO neondb_owner;
...
CREATE TABLE IF NOT EXISTS quiz_responses (
    ...
    is_correct TINYINT(1) DEFAULT false,
...
ALTER TABLE quiz_responses OWNER TO neondb_owner;
...
ALTER SEQUENCE quiz_responses_id_seq OWNER TO neondb_owner;

--
-- Name: quiz_responses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE quiz_responses_id_seq OWNED BY quiz_responses.id;
...
CREATE TABLE IF NOT EXISTS quiz_sessions (
    ...
    status quiz_session_status DEFAULT 'waiting'::quiz_session_status,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE quiz_sessions OWNER TO neondb_owner;
...
ALTER SEQUENCE quiz_sessions_id_seq OWNER TO neondb_owner;
...
CREATE TABLE IF NOT EXISTS quizzes (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    category character varying(100),
    difficulty quiz_difficulty DEFAULT 'beginner'::quiz_difficulty,
    type quiz_type DEFAULT 'free'::quiz_type,
    total_questions integer DEFAULT 0,
...
ALTER TABLE quizzes OWNER TO neondb_owner;
...
ALTER SEQUENCE quizzes_id_seq OWNER TO neondb_owner;
...
CREATE TABLE IF NOT EXISTS research_service_requests (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
ALTER TABLE research_service_requests OWNER TO neondb_owner;
...
ALTER SEQUENCE research_service_requests_id_seq OWNER TO neondb_owner;

--
-- Name: research_service_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE research_service_requests_id_seq OWNED BY research_service_requests.id;
...
ALTER TABLE settings OWNER TO neondb_owner;
...
ALTER SEQUENCE settings_id_seq OWNER TO neondb_owner;
...
ALTER TABLE test_questions OWNER TO neondb_owner;
...
ALTER SEQUENCE test_questions_id_seq OWNER TO neondb_owner;
...
ALTER TABLE test_responses OWNER TO neondb_owner;
...
ALTER SEQUENCE test_responses_id_seq OWNER TO neondb_owner;

--
-- Name: test_responses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE test_responses_id_seq OWNED BY test_responses.id;
...
CREATE TABLE IF NOT EXISTS users (
    ...
    email character varying(255),
    role user_role DEFAULT 'doctor'::user_role NOT NULL,
...
ALTER SEQUENCE users_id_seq OWNER TO neondb_owner;
...
COPY ai_tool_requests (id, user_id, tool_type, input_data, output_data, created_at) FROM stdin;
...
COPY bigtos_messages (id, mobile, message, image_url, type, api_response, status, created_at) FROM stdin;
...
COPY certificates (id, entity_type, entity_id, user_id, name, title, rank, score, background_image, output_url, sent_status, sent_at, created_at) FROM stdin;
...
COPY course_certificates (id, user_id, course_id, certificate_url, issued_at, sent_whatsapp, certificate_number) FROM stdin;
...
COPY course_modules (id, course_id, title, content_type, content_url, order_no, duration, is_preview, created_at) FROM stdin;
...
COPY course_progress (id, enrollment_id, module_id, completed, completed_at, score) FROM stdin;
1	1	4	t	\N	\N
2	1	5	t	\N	\N
3	3	14	t	\N	\N
4	3	15	t	\N	\N
...
COPY courses (id, title, description, instructor, duration, price, thumbnail_image, enrollment_count, is_active, created_at, updated_at) FROM stdin;
...
COPY enrollments (id, user_id, course_id, progress, completed_at, certificate_issued, enrolled_at, payment_status, payment_id) FROM stdin;
...
COPY entity_templates (id, entity_type, entity_id, background_image, font, text_color, text_positions, created_at, updated_at) FROM stdin;
...
COPY hospitals (id, name, address, city, state, country, phone, email, website, specialties, description, image, created_at, district, contact_numbers) FROM stdin;
...
COPY job_applications (id, job_id, user_id, cover_letter, status, applied_at) FROM stdin;
...
COPY jobs (id, title, hospital_id, hospital_name, specialty, location, state, city, experience_required, salary_range, job_type, description, requirements, posted_by, is_active, posted_at) FROM stdin;
...
COPY masterclass_bookings (id, user_id, masterclass_id, booked_at) FROM stdin;
...
COPY masterclasses (id, title, description, instructor, event_date, duration, max_participants, current_participants, price, location, thumbnail_image, is_active, created_at) FROM stdin;
...
COPY medical_voice_contacts (id, voice_id, name, designation, phone, email, is_primary, visible, created_at) FROM stdin;
...
COPY medical_voice_gathering_joins (id, voice_id, user_id, status, remarks, joined_at) FROM stdin;
...
COPY medical_voice_supporters (id, voice_id, user_id, motivation_note, joined_at) FROM stdin;
...
COPY medical_voice_updates (id, voice_id, update_title, update_body, created_at, notify_supporters) FROM stdin;
...
COPY module_tests (id, module_id, title, total_questions, passing_score, duration, created_at) FROM stdin;
...
COPY npa_automation (id, opt_in_id, user_id, month, year, generated_pdf_url, status, sent_date, last_error, template_used, created_at) FROM stdin;
...
COPY npa_opt_ins (id, user_id, doctor_profile_id, is_active, preferred_day, template_id, delivery_email, delivery_whatsapp, created_at, updated_at) FROM stdin;
...
COPY npa_templates (id, title, description, html_template, placeholders, is_active, created_at, updated_at) FROM stdin;
...
COPY quiz_attempts (id, user_id, quiz_id, score, total_questions, time_taken, passed, certificate_issued, attempted_at) FROM stdin;
...
COPY quiz_leaderboard (id, quiz_id, user_id, total_score, avg_time, rank, certificate_url, created_at) FROM stdin;
...
COPY quiz_questions (id, quiz_id, question_text, correct_option, order_index, image, marks, options) FROM stdin;
...
COPY quiz_responses (id, quiz_id, question_id, user_id, selected_option, is_correct, response_time, score, created_at) FROM stdin;
...
COPY quiz_sessions (id, quiz_id, current_question, started_at, status, created_at) FROM stdin;
...
COPY quizzes (id, title, description, passing_score, status, created_at, category, difficulty, type, total_questions, question_time, duration, entry_fee, reward_info, certificate_type, start_time, end_time, updated_at) FROM stdin;
...
COPY research_service_requests (id, user_id, service_type, title, description, status, assigned_to, estimated_cost, completed_at, created_at, updated_at) FROM stdin;
...
COPY settings (id, key, value, category, description, updated_at) FROM stdin;
...
COPY test_questions (id, test_id, question_no, description, option_a, option_b, option_c, option_d, correct_answer, marks) FROM stdin;
...
COPY test_responses (id, user_id, test_id, question_id, selected_option, is_correct, score, answered_at) FROM stdin;
...
COPY users (id, phone, email, role, otp_code, otp_expiry, is_verified, created_at, updated_at) FROM stdin;
...
ALTER TABLE ONLY ai_tool_requests
...
ALTER TABLE ONLY bigtos_messages
...
ALTER TABLE ONLY course_certificates
...
ALTER TABLE ONLY course_modules
...
ALTER TABLE ONLY course_progress
...
ALTER TABLE ONLY doctor_profiles
...
ALTER TABLE ONLY masterclass_bookings
...
ALTER TABLE ONLY masterclasses
...
ALTER TABLE ONLY medical_voice_contacts
...
ALTER TABLE ONLY medical_voice_gathering_joins
...
ALTER TABLE ONLY medical_voice_supporters
...
ALTER TABLE ONLY medical_voice_updates
...
ALTER TABLE ONLY medical_voices
...
ALTER TABLE ONLY npa_automation
...
ALTER TABLE ONLY npa_templates
...
ALTER TABLE ONLY quiz_leaderboard
...
ALTER TABLE ONLY quiz_responses
...
ALTER TABLE ONLY research_service_requests
...
ALTER TABLE ONLY test_responses
...
ALTER TABLE ONLY ai_tool_requests
    ADD CONSTRAINT ai_tool_requests_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY certificates
    ADD CONSTRAINT certificates_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY course_certificates
    ADD CONSTRAINT course_certificates_course_id_courses_id_fk FOREIGN KEY (course_id) REFERENCES courses(id);
...
ALTER TABLE ONLY course_certificates
    ADD CONSTRAINT course_certificates_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY course_modules
    ADD CONSTRAINT course_modules_course_id_courses_id_fk FOREIGN KEY (course_id) REFERENCES courses(id);
...
ALTER TABLE ONLY course_progress
    ADD CONSTRAINT course_progress_enrollment_id_enrollments_id_fk FOREIGN KEY (enrollment_id) REFERENCES enrollments(id);
...
ALTER TABLE ONLY course_progress
    ADD CONSTRAINT course_progress_module_id_course_modules_id_fk FOREIGN KEY (module_id) REFERENCES course_modules(id);
...
ALTER TABLE ONLY doctor_profiles
    ADD CONSTRAINT doctor_profiles_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY enrollments
    ADD CONSTRAINT enrollments_course_id_courses_id_fk FOREIGN KEY (course_id) REFERENCES courses(id);
...
ALTER TABLE ONLY enrollments
    ADD CONSTRAINT enrollments_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY job_applications
    ADD CONSTRAINT job_applications_job_id_jobs_id_fk FOREIGN KEY (job_id) REFERENCES jobs(id);
...
ALTER TABLE ONLY job_applications
    ADD CONSTRAINT job_applications_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY jobs
    ADD CONSTRAINT jobs_hospital_id_hospitals_id_fk FOREIGN KEY (hospital_id) REFERENCES hospitals(id);
...
ALTER TABLE ONLY jobs
    ADD CONSTRAINT jobs_posted_by_users_id_fk FOREIGN KEY (posted_by) REFERENCES users(id);
...
ALTER TABLE ONLY masterclass_bookings
    ADD CONSTRAINT masterclass_bookings_masterclass_id_masterclasses_id_fk FOREIGN KEY (masterclass_id) REFERENCES masterclasses(id);
...
ALTER TABLE ONLY masterclass_bookings
    ADD CONSTRAINT masterclass_bookings_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY medical_voice_contacts
    ADD CONSTRAINT medical_voice_contacts_voice_id_medical_voices_id_fk FOREIGN KEY (voice_id) REFERENCES medical_voices(id);
...
ALTER TABLE ONLY medical_voice_gathering_joins
    ADD CONSTRAINT medical_voice_gathering_joins_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY medical_voice_gathering_joins
    ADD CONSTRAINT medical_voice_gathering_joins_voice_id_medical_voices_id_fk FOREIGN KEY (voice_id) REFERENCES medical_voices(id);
...
ALTER TABLE ONLY medical_voice_supporters
    ADD CONSTRAINT medical_voice_supporters_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY medical_voice_supporters
    ADD CONSTRAINT medical_voice_supporters_voice_id_medical_voices_id_fk FOREIGN KEY (voice_id) REFERENCES medical_voices(id);
...
ALTER TABLE ONLY medical_voice_updates
    ADD CONSTRAINT medical_voice_updates_voice_id_medical_voices_id_fk FOREIGN KEY (voice_id) REFERENCES medical_voices(id);
...
ALTER TABLE ONLY medical_voices
    ADD CONSTRAINT medical_voices_creator_id_users_id_fk FOREIGN KEY (creator_id) REFERENCES users(id);
...
ALTER TABLE ONLY module_tests
    ADD CONSTRAINT module_tests_module_id_course_modules_id_fk FOREIGN KEY (module_id) REFERENCES course_modules(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY npa_automation
    ADD CONSTRAINT npa_automation_opt_in_id_npa_opt_ins_id_fk FOREIGN KEY (opt_in_id) REFERENCES npa_opt_ins(id);
...
ALTER TABLE ONLY npa_automation
    ADD CONSTRAINT npa_automation_template_used_npa_templates_id_fk FOREIGN KEY (template_used) REFERENCES npa_templates(id);
...
ALTER TABLE ONLY npa_automation
    ADD CONSTRAINT npa_automation_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY npa_opt_ins
    ADD CONSTRAINT npa_opt_ins_doctor_profile_id_doctor_profiles_id_fk FOREIGN KEY (doctor_profile_id) REFERENCES doctor_profiles(id);
...
ALTER TABLE ONLY npa_opt_ins
    ADD CONSTRAINT npa_opt_ins_template_id_npa_templates_id_fk FOREIGN KEY (template_id) REFERENCES npa_templates(id);
...
ALTER TABLE ONLY npa_opt_ins
    ADD CONSTRAINT npa_opt_ins_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY quiz_attempts
    ADD CONSTRAINT quiz_attempts_quiz_id_quizzes_id_fk FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
...
ALTER TABLE ONLY quiz_attempts
    ADD CONSTRAINT quiz_attempts_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY quiz_leaderboard
    ADD CONSTRAINT quiz_leaderboard_quiz_id_quizzes_id_fk FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
...
ALTER TABLE ONLY quiz_leaderboard
    ADD CONSTRAINT quiz_leaderboard_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY quiz_questions
    ADD CONSTRAINT quiz_questions_quiz_id_quizzes_id_fk FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
...
ALTER TABLE ONLY quiz_responses
    ADD CONSTRAINT quiz_responses_question_id_quiz_questions_id_fk FOREIGN KEY (question_id) REFERENCES quiz_questions(id);
...
ALTER TABLE ONLY quiz_responses
    ADD CONSTRAINT quiz_responses_quiz_id_quizzes_id_fk FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
...
ALTER TABLE ONLY quiz_responses
    ADD CONSTRAINT quiz_responses_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY quiz_sessions
    ADD CONSTRAINT quiz_sessions_quiz_id_quizzes_id_fk FOREIGN KEY (quiz_id) REFERENCES quizzes(id);
...
ALTER TABLE ONLY research_service_requests
    ADD CONSTRAINT research_service_requests_assigned_to_users_id_fk FOREIGN KEY (assigned_to) REFERENCES users(id);
...
ALTER TABLE ONLY research_service_requests
    ADD CONSTRAINT research_service_requests_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
...
ALTER TABLE ONLY test_questions
    ADD CONSTRAINT test_questions_test_id_module_tests_id_fk FOREIGN KEY (test_id) REFERENCES module_tests(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY test_responses
    ADD CONSTRAINT test_responses_question_id_test_questions_id_fk FOREIGN KEY (question_id) REFERENCES test_questions(id);
...
ALTER TABLE ONLY test_responses
    ADD CONSTRAINT test_responses_test_id_module_tests_id_fk FOREIGN KEY (test_id) REFERENCES module_tests(id);
...
ALTER TABLE ONLY test_responses
    ADD CONSTRAINT test_responses_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
